...
class BookingRepository extends BaseRepository
{
    ...
    // Veriable declarations is not according to PSR standard and lot of if condition are extra
    ...
    public function store($user, $data)
    {
        ...
        if ($user->user_type == env('CUSTOMER_ROLE_ID')) {
            ...
            if ($data['immediate'] == 'no') {
                ...
                // isset will check the value so don't need to check second condition $data['due_date'] == ''
...
//                 // isset will check the value so don't need to check second condition $data['due_time'] == ''
                ...
                // isset will check the value so don't need to check second condition $data['customer_physical_type'] == ''
                ...
                // isset will check the value so don't need to check second condition $data['duration'] == ''
